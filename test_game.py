...
class SnakeEnv:
    def __init__(self):
        ...
        self.state_size = 8  # snake_x, snake_y, food_x, food_y, direction
    ...
    def get_random_food_position(self):
        while True:
            ...
            if not any(segment.colliderect(food_rect) for segment in self.snake_list):
    ...
    for episode in range(1, episodes + 1):
        ...
        while not done:
            ...
            if done:
                ...
                # ax.axhline(mean_score, linestyle='--', color='r', label=f'Mean score ({mean_score:.2f})')
...
if __name__ == '__main__':
    ...
    scores = train(agent, env, 300, render=True)
    env.close()
